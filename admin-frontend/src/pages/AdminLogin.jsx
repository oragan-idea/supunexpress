            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-4">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#002E4D] to-[#004F74] rounded-xl blur-sm opacity-6 pointer-events-none"></div>
                  <input
                    type="email"
                    ...
                    required
                    className="relative w-full bg-white border-2 border-[#81BBDF]/30 rounded-xl p-3 sm:p-4 pl-10 focus:outline-none focus:border-[#002E4D] focus:ring-2 focus:ring-[#002E4D]/20 transition-all duration-300 text-[#002E4D] placeholder-[#004F74]/60"
                  />
