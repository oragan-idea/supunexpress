...
function App() {
  ...
  const handleSubmitLinks = async () => {
    ...
    try {
      // Save links to Firestore for admin management
      ...
      setSuccess("Links submitted, saved, and email sent successfully! ✅");
      setLinksList([]);
    } catch (err) {
      console.error(err);
      setError("❌ Failed to submit links, save, or send email. Please try again.");
    }
