...
const Login = () => {
  ...
  // Hardcoded admin credentials (for demo; in production, use secure backend check)
  ...
  // Redirect if already logged in (but not admin)
  if (user && user.email === ADMIN_USERNAME) {
    navigate('/admin-dashboard');
  } else if (user) {
    navigate('/');
  }
